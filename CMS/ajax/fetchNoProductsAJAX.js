...
pageLoadedOne = function () {
	...
	xhr.open("GET", "ajax/sql/totalProductsSQL.php", true);
...
pageLoadedTwo = function () {
	...
	// initialise a request, specifying the HTTP method
	// to be used and the URL to be connected to.
	xhr.open("GET", "ajax/sql/totalStockSQL.php", true);
	xhr.onreadystatechange = changeListener;
	xhr.send();
...
pageLoadedThree = function () {
	...
	// initialise a request, specifying the HTTP method
	// to be used and the URL to be connected to.
	xhr.open("GET", "ajax/sql/maxStockSQL.php", true);
	xhr.onreadystatechange = changeListener;
	xhr.send();
...
pageLoadedFour = function () {
	...
	// initialise a request, specifying the HTTP method
	// to be used and the URL to be connected to.
	xhr.open("GET", "ajax/sql/minStock.php", true);
	xhr.onreadystatechange = changeListener;
	xhr.send();
...
noStock= function () {
	...
	// initialise a request, specifying the HTTP method
	// to be used and the URL to be connected to.
	xhr.open("GET", "ajax/sql/noStockSQL.php", true);
	xhr.onreadystatechange = changeListener;
	xhr.send();
